...
python3 data.py waterTemperature.csv energy.csv
```
## Assumptions:
...
- Energy file, first date is not listed in the temeperature file (Doesn't make sense, but work for this time homework data files.)
